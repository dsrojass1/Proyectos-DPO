...
public class FCrearServicioSpa extends JFrame {
	...
	private JLabel lblTitle = new JLabel("Crear Servicio Spa");
	...
	FCrearServicioSpa(Control control){
	...
	protected void crearSpa() {
		if (control.crearSpa(this.tfHash.get("Id del servicio:").getText(), Integer.parseInt(this.tfHash.get("Precio:").getText()), this.tfHash.get("Descripción:").getText(), this.cbLlevarHabitacion.isSelected())) {
